...
public class Sinif1GameManager : MonoBehaviour
{
    [SerializeField]
    ...
    Sinif1TimerManager Sinif1TimerManager;

    Sinif1DairelerManager Sinif1DairelerManager;

    Sinif1DogruYanlisYonetim Sinif1DogruYanlisYonetim;

    Sinif1DegerlendirmeYoneticisi Sinif1DegerlendirmeYoneticisi;
    ...
    private void Awake()
    {
        Sinif1TimerManager=Object.FindObjectOfType<Sinif1TimerManager>();
        Sinif1DairelerManager=Object.FindObjectOfType<Sinif1DairelerManager>();
        Sinif1DogruYanlisYonetim=Object.FindObjectOfType<Sinif1DogruYanlisYonetim>();
    ...
    public void OyunaBasla()
    {
        ...
        kacinciOyun();
        Sinif1TimerManager.SureyiBaslat();
    }
    ...
    {
        int RastgeleDeger=Random.Range(0,20);

        if(RastgeleDeger<=5)
        {
            UstDeger=Random.Range(2,15);
    ...
    {
        int BirinciSayi=Random.Range(1,5);
        int IkinciSayi=Random.Range(1,8);
        int UcuncuSayi=Random.Range(1,6);
        int DorduncuSayi=Random.Range(1,9);
    ...
    {
        int BirinciSayi=Random.Range(6,10);
        int IkinciSayi=Random.Range(1,6);
        int UcuncuSayi=Random.Range(7,10);
    ...
    public void ButonDegerBelirle(string ButonAdi)
    {
        ...
        {
            Sinif1DogruYanlisYonetim.DogruYanlisAc(true);
            Sinif1DairelerManager.DaireScaleAc(OyunSayac % 3);
            OyunSayac++;
        ...
        {
            Sinif1DogruYanlisYonetim.DogruYanlisAc(false);
            HatadaSayacAzalt();
    ...
    void HatadaSayacAzalt()
    {
        ...
        if(OyunSayac<0)
        {
         ...
         Sinif1DairelerManager.DaireScaleKapat();
    }
    ...
    public void OyunSonu()
    {
        ...
        Sinif1DegerlendirmeYoneticisi=Object.FindObjectOfType<Sinif1DegerlendirmeYoneticisi>();

        Sinif1DegerlendirmeYoneticisi.DegerlerdirmeEkrani(DogruSayisi,YanlisSayisi,ToplamPuan);
    }
